...
const STYLES: SlideStyle[] = [
  ...
  { id: 'classic-newspaper', name: '经典报纸', emoji: '📰', bg: 'bg-amber-100', color: 'text-gray-800' },
  { id: 'health-warning', name: '健康警示', emoji: '⚠️', bg: 'bg-yellow-500', color: 'text-black' },
  { id: 'magazine-cover', name: '杂志封面', emoji: '📚', bg: 'bg-white', color: 'text-blue-800' },
];
...
export const STYLE_DESCRIPTIONS = {
  'classic-newspaper': {
    name: '经典老年报纸健康专版',
    description: '模仿90年代经典报纸健康专栏的科普图文设计，采用微微泛黄的粗糙宣纸背景，双栏排版，醒目的标题块和专业的医学风格。',
    keywords: '严谨、信赖、醒目、分栏'
  },
  'health-warning': {
    name: '冲击力极强的健康警示特刊',
    description: '具有极大视觉冲击力的健康警示特刊头条设计，采用高对比度背景，醒目的红色警示牌形状，重点突出的文字排版。',
    keywords: '视觉冲击、重点突出、高对比度'
  },
  'magazine-cover': {
    name: '图文并茂的《大众健康》杂志封面风格',
    description: '模仿老牌《大众健康》杂志封面的科普设计，纯白背景，左侧文字区，右侧写实插画，专业的医学示意图和清晰的排版。',
    keywords: '形象直观、写实配图、排版灵活'
  }
};
